    ...
    <div className="flex flex-col h-screen bg-gradient-to-r from-gray-100 to-gray-300">
      ...
      <div className="w-full bg-gray-800 text-white py-4 px-8 flex items-center justify-between shadow-lg">
        ...
        <div className="space-x-4">
          <Link href="/Devoir"><Button className="text-sm sm:text-lg bg-gray-600 text-white py-2 px-4 hover:bg-gray-700">Devoir</Button></Link>
          <Link href="/IA"><Button className="text-sm sm:text-lg bg-gray-600 text-white py-2 px-4 hover:bg-gray-700">IA</Button></Link>
          <Link href="/Logout"><Button className="text-sm sm:text-lg bg-blue-400 text-white py-2 px-4 hover:bg-blue-300">Logout</Button></Link>
        </div>
      </div>
